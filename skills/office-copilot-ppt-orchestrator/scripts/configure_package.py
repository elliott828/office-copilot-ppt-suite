...
def main() -> int:
    ...
    shutil.copytree(skill_root / "office-copilot", output / "office-copilot")
    shutil.copytree(
        skill_root / "assets" / "shared-folder-template",
        output / "shared-folder-template",
    )
    shutil.copy2(skill_root / "references" / "deployment.md", output / "deployment.md")
